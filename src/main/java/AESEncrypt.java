...
public class AESEncrypt {
    ...
    public static void main(String[] args) throws Exception {
        ...
        byte[] encryptedText = AESEncrypt.encryptWithPrefixIV(pText.getBytes(UTF_8), secretKey, iv);
        System.out.println(System.currentTimeMillis() - startTime + " is the time taken for AES");
